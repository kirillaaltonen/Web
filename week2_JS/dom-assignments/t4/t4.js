...
function renderRestaurants(sortedRestaurants) {
  sortedRestaurants.forEach(restaurant => {
    ...
    addressTd.textContent = `${restaurant.address}, ${restaurant.city}`;
...
navigator.geolocation.getCurrentPosition(position => {
  ...
  restaurants.sort((a, b) => {
    const distanceA = getDistance(userCoords, a.location.coordinates);
    const distanceB = getDistance(userCoords, b.location.coordinates);
